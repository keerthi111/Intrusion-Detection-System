...
#define TOTAL_OBJECT              54                // no of object inlude in training purpose
...
#define TOTAL_TEST_OBJECT		  155                 //Number f testing object
...
int main(){
	...
	infile1.open("U2R_and_R2l_Class_data250_raw.txt");              //This file contans attribute data in real value formate
	infile2.open("rules_class2_binary");            //Generated Rule by training dataset using hybrid GA
	//infile3.open("discretization_usefull_data");    //Usefull data for Dscretization of new objects
	infile4.open("reduct_attribute_index_class2");         //Optimize reduct attribute index

    ofstream outfile4,outfile5;                              //Declare objects for open file in writting mode
	outfile4.open("testing_result_class2");                //Store final classified result for testing object
